...
The Helimod device works just as a standard joystick would work as a "plug-and-play" device. It is designed to be recognized by the computer as soon as it is plugged in to its USB port. The computer will recognize the Helimod as a game controller and does have a capability of calibrating the control input to the desired sensitivity. 
